...
def main(args):
    ...
    # message='x2={}'.format(curve[0])+' x={}'.format(curve[1]),'intercept={}'.format(curve[2])
    # logging.info("Curve values = "+message)
    ...
    # logging.info('Plotting PeakInspector')
    ...
    outfile = os.path.join(output_dir, basename+'ApexList.txt')
...
if __name__ == '__main__':
    ...
    filename_with_extension = os.path.basename(args.infile)
    # basename = filename_with_extension[:filename_with_extension.rfind('_') + 1]
